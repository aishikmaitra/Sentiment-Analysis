...
const API_URL = 'SENTIMENT_API_ENDPOINT'; // Replace with your actual sentiment analysis API endpoint
      ...
      <div className="container ">
        <div className="row mb-5">
          <div className="col-md-6 col-sm-12">
            <div className="bg-grey text-white mb-4">
              ...
              <h4 className="font-weight-bold mt-5">Uncover Emotions, Harness Insights: Your Sentiments Analyzed, Empowering Better Understanding.</h4>
            </div>
          </div>
          <div className="col-md-6 col-sm-12">
        ...
        <div className="row">
          <div className="col-md-6 col-sm-12 justify-content-start">
            <label className='d-flex mt-3'>Enter your text : </label>
